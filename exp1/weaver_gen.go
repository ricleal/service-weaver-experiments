...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦f9fb0ae0:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→exp/count/Counter⟧\n⟦1842815b:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→exp/reverse/Reverser⟧\n",
	})
}
